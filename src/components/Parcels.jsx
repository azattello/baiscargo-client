...
const Parcels = () => {
    ...
    useEffect(() => {
        const fetchBookmarks = async () => {
            try {
                const response = await axios.get(`http://86.107.44.226:3001/api/bookmark/${userId}/getBookmarks`);
    ...
    useEffect(() => {
        const fetchArchive = async () => {
            try {
                const response = await axios.get(`http://86.107.44.226:3001/api/archive/${userId}/getArchive`);
    ...
    const removeBookmark = async (trackNumber) => {
        ...
        if (confirmDelete) {
            try {
                const response = await fetch(`http://86.107.44.226:3001/api/archive/${userId}/delete/${trackNumber}`, {
                    method: 'DELETE',
                });
