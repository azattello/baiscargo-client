...
export const addStatus = async (statusText) => {
  ...
  try {
    ...
    const response = await axios.post('http://86.107.44.226:3001/api/status/addStatus', {
      statusText
    });
...
export const getStatus = async () => {
  try {
      const response = await axios.get('http://86.107.44.226:3001/api/status/getStatus');
...
export const deleteStatus = async (statusId) => {
  try {
    ...
    const response = await axios.delete(`http://86.107.44.226:3001/api/status/deleteStatus/${statusId}`);
